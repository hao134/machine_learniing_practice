'''
this code is all from morvan_course.
compare the overfitting result and use the dropout way
'''
...
# Hyper parameters 
N_SAMPLES = 20
N_HIDDEN  = 300   # Nodes == Features is big makes overfitting
...
tf_is_training = tf.placeholder(tf.bool, None) # booling / to control dropout when traning and testing
...
for t in range(500):
    ...
    if t % 10 == 0:
        ...
        plt.legend(loc='upper left'); plt.ylim((-2.5, 2.5)); plt.pause(0.5)
